...
wb = load_workbook("clientes.xlsx")  # Carregar o arquivo Excel criado
ws = wb.active  # Seleciona a planilha ativa (geralmente a primeira)
...
wb.save("clientes_ajustado.xlsx")
